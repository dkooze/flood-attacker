...
echo -e " $Green                           ==>️$Cyan[2️⃣] Sms Fl00der"
echo -e " $Green                           ==>$Cyan[3️⃣] call Fl00der"
echo -e " $Green                           ️==>$Cyan[4️⃣] Update script"
echo -e " $Green                           ==>$Cyan[5️⃣] Remove script"
echo -e " $Green                           ️==>$Cyan[6️⃣] About"
echo -e " $Green                           ==>$Cyan[7️⃣] exit"
echo " "
echo " "
